	                    ...
	                    <form action="{{route('admin.email.search',$scope ?? str_replace('admin.email.', '', request()->route()->getName()))}}" method="GET">
	                        <div class="row align-items-center">
	                            <div class="col-lg-5">
	                                ...
	                                <input type="text" autocomplete="off" name="search" value="" placeholder="{{translate('Search with User, Email or To Recipient Email')}}" class="form-control" id="search" value="{{@$search}}">
	                            </div>
	                            <div class="col-lg-5">
	                                <label>
                                        {{ translate('By Date') }}
