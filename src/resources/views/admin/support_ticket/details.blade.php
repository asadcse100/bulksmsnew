		...
		<div class="row d-flex align--center rounded">
			<div class="col-xl-12">
				<div class="table_heading d-flex align--center justify--between">
                    ...
                    <a href="{{route('admin.support.ticket.index')}}" class="btn--dark text--light border-0 px-2 py-1 rounded ms-3"><i class="las la-angle-double-left"></i> {{translate('Go Back')}}</a>
                </div>
