...
<section class="mt-3 rounded_box">
	...
	<div class="container-fluid p-0 pb-2">
		<div class="row d-flex align--center rounded">
			<div class="col-xl-12">
				<div class="col-xl">
					<form action="{{route('admin.template.email.store')}}" method="POST" enctype="multipart/form-data">
						@csrf
					    ...
					    <div class="card mb-3">
						    ...
						    <div class="card-body">
						    	<div class="row">
									...
									<div class="col-md-6 mb-2">
										<label class="form-label">
											{{ translate('Select Provider')}} <sup class="text-danger">*</sup>
										</label>
										<div class="input-group input-group-merge">
											  <select class="form-control" name="provider" id="provider">
                                                 <option value="">
                                                    {{translate('Select A Provider')}}
                                                 </option>
...
@push('script-include')
    <script src="{{asset('assets/global/js/template.js') }}"></script>
    <script src="{{asset('assets/global/js/BeePlugin.js') }}"></script>
