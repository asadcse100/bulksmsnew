        ...
        <div class="row align--center">
            <div class="col-6">
                <div class="d--flex">
                    ...
                    <div>
                        <a target="_blank" class="ms-2 d--flex align--center top-icon" href="{{url('/')}}">
                            <i class="las fs--9 la-globe"></i>
                        </a>
                    </div>


                    <div>
                        <a class="d--flex align--center top-icon" href="{{route('admin.general.setting.cache.clear')}}">
