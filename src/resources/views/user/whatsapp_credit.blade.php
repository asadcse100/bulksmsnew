    ...
    <div class="container-fluid p-0">
	    <div class="row">
	    	<div class="col-lg-12">
	            <div class="card mb-4">
	                <div class="card-body">
	                    <form action="{{route('user.whatsapp.credit.search')}}" method="GET">
	            ...
	            <div class="card mb-4">
		            <div class="responsive-table">
		                <table class="m-0 text-center table--light">
		                    ...
		                    @forelse($whatsappCredits as $creditdata)
			                    <tr class="@if($loop->even)@endif">
				                    ...
				                    <td data-label="{{ translate('Credit')}}">
				                    	<span class="@if($creditdata->type == '+')text--success @else text--danger @endif">{{ $creditdata->type }} {{shortAmount($creditdata->credit)}}
