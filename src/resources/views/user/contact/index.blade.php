	                ...
	                <div class="row align--center px-2">
	                	...
	                	<div class="col-12 col-md-8 col-lg-8 col-xl-7">
	                		<div class="row justify-content-end">
			                    ...
			                    <div class="col-12 col-md-4 col-lg-4 col-xl-3 py-1">
                                    @if(@$group)
                                        <a href="{{route('user.phone.book.contact.group.export', $group->id)}}" class="w-100 d-block btn--warning text--light border-0 px-1 py-2 rounded ms-2"><i class="las la-cloud-download-alt"></i> {{ translate('Export Contact')}}</a>
                                    @else
			                    	    <a href="{{route('user.phone.book.contact.export')}}" class="w-100 d-block btn--warning text--light border-0 px-1 py-2 rounded ms-2"><i class="las la-cloud-download-alt"></i> {{ translate('Export Contact')}}</a>
                                    @endif
			                    </div>
	            	...
	            	<div class="card">
		                ...
		                <div class="card-body">
							...
							<div class="mb-3">
								...
								<a href="{{route('demo.file.downlode','xlsx')}}">{{ translate('exel')}}</a>
