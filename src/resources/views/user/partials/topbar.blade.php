                    ...
                    <ul>
                        ...
                        <li class="drop-down">
                            ...
                            <ul class="dropdown-menu drop_down_width" aria-labelledby="dropdownMenuButton1">
                                <li>
                                    <a class="dropdown-item" href="{{route('user.profile')}}"><i class="me-1 las la-cog"></i>{{translate('Profile Setting')}}</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{route('user.password')}}"><i class="me-1 las la-lock"></i>{{translate('Password Update')}}</a>
                                </li> 
                                <li>
                                    <a class="dropdown-item" href="{{route('logout')}}"><i class="me-1 las la-sign-in-alt"></i>{{translate('Logout')}}</a>
                                </li>
                            </ul>
                        </li>
