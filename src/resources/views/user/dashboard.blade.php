        ...
        <div class="row g-3">
            <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                <div class="info-card style-purple">
                    ...
                    <div class="content">
                        ...
                        <p>{{ translate('Remaining SMS Credit')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                <div class="info-card style-purple">
                    ...
                    <div class="content">
                        ...
                        <p>{{ translate('Remaining Email Credit')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                <div class="info-card style-purple">
                    ...
                    <div class="content">
                        ...
                        <p>{{ translate('Remaining WhatsApp Credit')}}</p>
                    </div>
                </div>
            </div>

            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-sky">
                    <div class="icon">
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-sky">
                    ...
                    <div class="content">
                        <h4>{{$smslog['pending']}}</h4>
                        <p>{{ translate('Total Pending SMS')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-sky">
                    ...
                    <div class="content">
                        ...
                        <p>{{ translate('Total Delivered SMS')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-sky">
                    ...
                    <div class="content">
                        <h4>{{$smslog['fail']}}</h4>
                        <p>{{ translate('Total Failed SMS')}}</p>
                    </div>
                </div>
            </div>

            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-red">
                    <div class="icon">
                        <i class="las la-envelope"></i>
                    </div>
                    <div class="content">
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-red">
                    ...
                    <div class="content">
                        <h4>{{$emailLog['pending']}}</h4>
                        <p>{{ translate('Total Pending Email')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-red">
                    ...
                    <div class="content">
                        ...
                        <p>{{ translate('Total Delivered Email')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-red">
                    ...
                    <div class="content">
                        <h4>{{$emailLog['fail']}}</h4>
                        <p>{{ translate('Total Failed Email')}}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-green">
                    ...
                    <div class="content">
                        ...
                        <p>{{ translate('Total WhatsApp Message')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-green">
                    ...
                    <div class="content">
                        ...
                        <p>{{ translate('Total Delivered WhatsApp Message')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                <div class="info-card style-green">
                    ...
                    <div class="content">
                        <h4>{{$whatsappLog['fail']}}</h4>
                        <p>{{ translate('Total Failed WhatsApp')}}</p>
                    </div>
                </div>
            </div>
