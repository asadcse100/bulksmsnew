				          		...
				          		<div class="row">
				          			<div class="mb-3">
					            		...
					            		<div class="input-group input-group-merge">
					              			<div class="form-check form-check-inline">
					              				<div class="form-check form-check-inline">
													<input {{old("smsType") == "plain" ?'checked' :"" }} class="form-check-input" type="radio" name="smsType" id="smsTypeText" value="plain" checked="">
					          		...
					          		<div class="md-12">
					            		...
					            		<div class="input-group input-group-merge speech-to-text" id="messageBox">
										  	...
										  	<textarea class="form-control" maxlength="{{charactersLeft()}}" class="form-control" name="message" id="message" placeholder="{{ translate('Enter SMS Content &  For Mention Name Use ')}}@php echo "{{". 'name' ."}}"  @endphp"
                                            aria-describedby="text-to-speech-icon">{{session()->get('user_sms_message')}} </textarea>
