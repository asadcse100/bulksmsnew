                                ...
                                @forelse($smsGateways as $smsGateway)
                                    <tr class="@if($loop->even)@endif">
                                        ...
                                        <td data-label="{{ translate('Action')}}">
                                            <a href="{{route('user.sms.gateway.edit', $smsGateway->id)}}" class="btn--primary text--light brand" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="las la-pen"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
