                        ...
                        <div class="col-12 col-md-8 col-lg-8 col-xl-7">
                            <div class="row mb-2">
                                <div class="col-6 col-md-6 col-lg-5 col-xl-3 px-2 py-1">
                                    <a href="{{route('user.template.email.create')}}" class="w-100 btn--success text--light border-0 px-1 py-2 rounded ms-2" ><i class="las la-plus"></i>{{translate('Create Template')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            @forelse($emailTemplates as $emailTemplate)
                                <tr class="@if($loop->even)@endif">
                                    ...
                                    <td data-label={{ translate('Action') }}>
                                        <a class="btn--primary text--light me-2" href="{{route('user.template.email.edit', $emailTemplate->id)}}"><i class="las la-pen"></i></a>
