	                ...
	                <div class="card-body">
                    	<form action="{{route('user.campaign.search')}}" method="post">
	                        ...
	                        <div class="row align-items-center">
								...
								<div class="col-lg-1">
									@php
									    $routeName =  "user.campaign.".strtolower($chanel);
									@endphp
	                            ...
	                            <div class="col-lg-1">
	                                <a href="{{route('user.campaign.create',strtolower($chanel))}}" class="btn btn--info w-100 h-45 mt-4" type="submit">
		                    ...
		                    @forelse($campaigns as $campaign)
			                    <tr class="@if($loop->even)@endif">
				                    ...
				                    <td data-label="{{ translate('Contacts')}}">
										<a href="{{route('user.campaign.contacts',$campaign->id)}}" class="s_btn--primary text--light"> {{ translate('view Contact')}} ({{$campaign->contacts->count()}}) </a>
				                    </td>
				                    ...
				                    <td data-label={{ translate('Action')}}>
										...
										<a href="{{route('user.campaign.edit',$campaign->id)}}" class="btn--info text--light"><i class="las la-pen"></i>
									   </a>
