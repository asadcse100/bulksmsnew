...
class CustomerController extends Controller
{
    ...
    {
        $title = "Active user";
        $customers = $this->customerService->getPaginateActiveUsers();
        return view('admin.customer.index', compact('title', 'customers'));
    }
    ...
    {
        $title = "Banned user";
        $customers = $this->customerService->getPaginateBannedUsers();
        return view('admin.customer.index', compact('title', 'customers'));
    }
    ...
    public function details($id): View
    {
        ...
        $log = $this->customerService->logs($user->id);
    ...
    public function search(Request $request, $scope)
    {
        ...
        [$title, $customers] = $this->customerService->applyCustomerStatusFilter($customers, $scope);

        $customers = $customers->paginate(paginateNumber());

        $title .= 'User Search - ' . $search;
        return view('admin.customer.index', compact('title', 'search', 'scope', 'customers', 'searchDate'));
    }
