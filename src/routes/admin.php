...
Route::prefix('admin')->name('admin.')->group(function () {
	...
	Route::middleware(['admin','demo.mode'])->group(function () {
        ...
        Route::prefix('users')->name('user.')->group(function () {
            ...
            Route::get('/banned', [CustomerController::class, 'banned'])->name('banned');
            Route::get('/detail/{id}', [CustomerController::class, 'details'])->name('details');
            Route::post('/update/{id}', [CustomerController::class, 'update'])->name('update');
            Route::get('/search/{scope}', [CustomerController::class, 'search'])->name('search');
	   ...
	   //BEE FREE PLUGIN SETUP
        ...
        Route::prefix('support/tickets')->name('support.ticket.')->group(function () {
            ...
            Route::get('/download/{id}', [SupportTicketController::class, 'supportTicketDownlode'])->name('download');
        ...
        Route::prefix('mail/gateways/')->name('mail.')->group(function () {
            ...
            Route::post('update/{id}', [MailConfigurationController::class, 'mailUpdate'])->name('update');
            Route::get('edit/{id}', [MailConfigurationController::class, 'edit'])->name('edit');
            Route::post('send', [MailConfigurationController::class, 'sendMailMethod'])->name('send.method');
            Route::get('global-template', [MailConfigurationController::class, 'globalTemplate'])->name('global.template');
            Route::post('global-template/update', [MailConfigurationController::class, 'globalTemplateUpdate'])->name('global.template.update');
            Route::post('test/{id}', [MailConfigurationController::class, 'mailTester'])->name('test');
        });
        ...
        Route::prefix('sms/gateways/')->name('sms.gateway.')->group(function () {
            ...
            Route::post('update/{id}', [SmsGatewayController::class, 'update'])->name('update');
        ...
        Route::prefix('sms/own/groups/')->name('group.own.sms.')->group(function () {
            Route::get('', [OwnGroupController::class, 'smsIndex'])->name('index');
        ...
        Route::prefix('email/own/groups/')->name('group.own.email.')->group(function () {
            Route::get('', [OwnGroupController::class, 'emailIndex'])->name('index');
